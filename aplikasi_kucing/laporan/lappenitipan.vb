...
Public Class lappenitipan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aplikasi_kucing.lappenitipan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlappenitipan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lappenitipan = New lappenitipan()
        rpt.Site = Me.Site
        Return rpt
    End Function
