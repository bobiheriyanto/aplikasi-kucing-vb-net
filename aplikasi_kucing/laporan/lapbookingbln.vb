...
Public Class lapbookingbln
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aplikasi_kucing.lapbookingbln.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlapbookingbln
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lapbookingbln = New lapbookingbln()
        rpt.Site = Me.Site
        Return rpt
    End Function
