...
Public Class lappenitipanthn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aplikasi_kucing.lappenitipanthn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlappenitipanthn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lappenitipanthn = New lappenitipanthn()
        rpt.Site = Me.Site
        Return rpt
    End Function
