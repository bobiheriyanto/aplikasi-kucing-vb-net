...
Public Class lapbookingthn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aplikasi_kucing.lapbookingthn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlapbookingthn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lapbookingthn = New lapbookingthn()
        rpt.Site = Me.Site
        Return rpt
    End Function
