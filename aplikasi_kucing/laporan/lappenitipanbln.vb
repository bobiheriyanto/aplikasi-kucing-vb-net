...
Public Class lappenitipanbln
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aplikasi_kucing.lappenitipanbln.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlappenitipanbln
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lappenitipanbln = New lappenitipanbln()
        rpt.Site = Me.Site
        Return rpt
    End Function
